...
export const listPullRequestReviewRequestsQueryKey = (options: Options<ListPullRequestReviewRequestsData>) => createQueryKey('listPullRequestReviewRequests', options, false, ['Pull Requests']);

/**
 * List active reviewer requests for the exact current pull request CID
 */
export const listPullRequestReviewRequestsOptions = (options: Options<ListPullRequestReviewRequestsData>) => queryOptions<ListPullRequestReviewRequestsResponse, ListPullRequestReviewRequestsError, ListPullRequestReviewRequestsResponse, ReturnType<typeof listPullRequestReviewRequestsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listPullRequestReviewRequests({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listPullRequestReviewRequestsQueryKey(options)
});

export const listPullRequestReviewRequestsInfiniteQueryKey = (options: Options<ListPullRequestReviewRequestsData>): QueryKey<Options<ListPullRequestReviewRequestsData>> => createQueryKey('listPullRequestReviewRequests', options, true);

/**
 * List active reviewer requests for the exact current pull request CID
 */
export const listPullRequestReviewRequestsInfiniteOptions = (options: Options<ListPullRequestReviewRequestsData>) => {
    const opts = infiniteQueryOptions<ListPullRequestReviewRequestsResponse, ListPullRequestReviewRequestsError, InfiniteData<ListPullRequestReviewRequestsResponse>, QueryKey<Options<ListPullRequestReviewRequestsData>>, string | Pick<QueryKey<Options<ListPullRequestReviewRequestsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListPullRequestReviewRequestsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    cursor: pageParam
                }
            };
        ...
        queryKey: listPullRequestReviewRequestsInfiniteQueryKey(options)
    });
    return opts as Omit<typeof opts, 'initialData'>;
};
 ...
 */
export const deletePullRequestReviewRequestMutation = (options?: Partial<Options<DeletePullRequestReviewRequestData>>): UseMutationOptions<unknown, DeletePullRequestReviewRequestError, Options<DeletePullRequestReviewRequestData>> => {
    const mutationOptions: UseMutationOptions<unknown, DeletePullRequestReviewRequestError, Options<DeletePullRequestReviewRequestData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deletePullRequestReviewRequest({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const putPullRequestReviewRequestMutation = (options?: Partial<Options<PutPullRequestReviewRequestData>>): UseMutationOptions<PutPullRequestReviewRequestResponse, PutPullRequestReviewRequestError, Options<PutPullRequestReviewRequestData>> => {
    const mutationOptions: UseMutationOptions<PutPullRequestReviewRequestResponse, PutPullRequestReviewRequestError, Options<PutPullRequestReviewRequestData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await putPullRequestReviewRequest({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
