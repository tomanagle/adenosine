 ...
 */
export const listPullRequestReviewRequests = <ThrowOnError extends boolean = false>(options: Options<ListPullRequestReviewRequestsData, ThrowOnError>): RequestResult<ListPullRequestReviewRequestsResponses, ListPullRequestReviewRequestsErrors, ThrowOnError> => (options.client ?? client).get<ListPullRequestReviewRequestsResponses, ListPullRequestReviewRequestsErrors, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: z.never().optional(),
        path: z.never().optional(),
        query: zListPullRequestReviewRequestsQuery
    }).parseAsync(data),
    responseValidator: async (data) => await zListPullRequestReviewRequestsResponse.parseAsync(data),
    security: [{
            in: 'cookie',
            name: 'adenosine_session',
            type: 'apiKey'
 ...
 */
export const deletePullRequestReviewRequest = <ThrowOnError extends boolean = false>(options: Options<DeletePullRequestReviewRequestData, ThrowOnError>): RequestResult<DeletePullRequestReviewRequestResponses, DeletePullRequestReviewRequestErrors, ThrowOnError> => (options.client ?? client).delete<DeletePullRequestReviewRequestResponses, DeletePullRequestReviewRequestErrors, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: z.never().optional(),
        headers: zDeletePullRequestReviewRequestHeaders.optional(),
        path: zDeletePullRequestReviewRequestPath,
        query: zDeletePullRequestReviewRequestQuery
    }).parseAsync(data),
    security: [{
            in: 'cookie',
            name: 'adenosine_session',
 ...
 *
 * The target repository owner publishes a deterministic record keyed by pull request and reviewer. Repository triage authority, reviewer visibility, blocks, and hidden records are enforced before publication.
 */
export const putPullRequestReviewRequest = <ThrowOnError extends boolean = false>(options: Options<PutPullRequestReviewRequestData, ThrowOnError>): RequestResult<PutPullRequestReviewRequestResponses, PutPullRequestReviewRequestErrors, ThrowOnError> => (options.client ?? client).put<PutPullRequestReviewRequestResponses, PutPullRequestReviewRequestErrors, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: zPutPullRequestReviewRequestBody,
        headers: zPutPullRequestReviewRequestHeaders.optional(),
        path: zPutPullRequestReviewRequestPath,
        query: z.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zPutPullRequestReviewRequestResponse.parseAsync(data),
    security: [{
            in: 'cookie',
            name: 'adenosine_session',
            type: 'apiKey'
